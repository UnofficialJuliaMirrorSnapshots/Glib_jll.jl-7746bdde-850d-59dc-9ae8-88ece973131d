...
const libgio_splitpath = ["bin", "libgio-2.0-0.dll"]
...
const libgio = "libgio-2.0-0.dll"


# Relative path to `libgmodule`
const libgmodule_splitpath = ["bin", "libgmodule-2.0-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libgmodule = "libgmodule-2.0-0.dll"


# Relative path to `libgthread`
const libgthread_splitpath = ["bin", "libgthread-2.0-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libgthread = "libgthread-2.0-0.dll"


# Relative path to `libglib`
const libglib_splitpath = ["bin", "libglib-2.0-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libglib = "libglib-2.0-0.dll"


# Relative path to `libgobject`
const libgobject_splitpath = ["bin", "libgobject-2.0-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libgobject = "libgobject-2.0-0.dll"
